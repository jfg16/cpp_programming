...
/* functions have been DEFINED above.  This satisfies declare-before-use
 * for anything appearing below.  The function definitions also count as
 * declarations, because each function's header is the same as its 
 * declaration
 */
